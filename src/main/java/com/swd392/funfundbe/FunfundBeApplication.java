...
@OpenAPIDefinition(
		...
		tags = {
				...
				@Tag(name = "authenticate", description = "REST API endpoint for authenticating user"),
				@Tag(name = "user", description = "REST API endpoints for user features"),
				@Tag(name = "admin", description = "REST API endpoints for admin features")
		}
)
@Slf4j
