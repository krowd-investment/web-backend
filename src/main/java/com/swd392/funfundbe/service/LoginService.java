...
public class LoginService {
    ...
    // private final String TWILIO_SERVICE_SID =
    // System.getenv("TWILIO_SERVICE_SID");
    //
    // @PostConstruct
    // public void initVerifier() {
    // verifier = new GoogleIdTokenVerifier.Builder(new NetHttpTransport(), new
    // GsonFactory())
    ...
    // log.info("OTP has been successfully generated, and awaits your verification
    // {}", LocalDateTime.now());
    // }
    //
